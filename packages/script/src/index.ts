...
const env = {
  OPENCODE_CHANNEL: process.env["KITO_CHANNEL"] ?? process.env["OPENCODE_CHANNEL"],
  OPENCODE_BUMP: process.env["KITO_BUMP"] ?? process.env["OPENCODE_BUMP"],
  OPENCODE_VERSION: process.env["KITO_VERSION"] ?? process.env["OPENCODE_VERSION"],
  OPENCODE_RELEASE: process.env["KITO_RELEASE"] ?? process.env["OPENCODE_RELEASE"],
}
