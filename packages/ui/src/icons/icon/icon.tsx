...
const icons = {
  ...
  globe: {
    viewBox: "0 0 16 16",
    body: `<path d="M14 8A6 6 0 1 1 2 8A6 6 0 1 1 14 8M11 8A3 6 0 1 1 5 8A3 6 0 1 1 11 8M2 8H14" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="square"/>`,
  },
  help: {
    viewBox: "0 0 16 16",
