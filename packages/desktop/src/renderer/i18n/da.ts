export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Kito er blevet downloadet. Vil du installere den og genstarte?",
