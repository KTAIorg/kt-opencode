export const dict = {
  ...
  "desktop.updater.none.message": "Már az Kito legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Kito {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
