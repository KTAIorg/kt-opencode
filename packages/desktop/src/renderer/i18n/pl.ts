export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Kito. Czy chcesz ją zainstalować i uruchomić ponownie?",
