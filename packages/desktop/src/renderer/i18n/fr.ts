export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de Kito a été téléchargée. Voulez-vous l'installer et redémarrer ?",
