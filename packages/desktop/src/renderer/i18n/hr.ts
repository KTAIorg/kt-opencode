export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Kito. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
