export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Kito është shkarkuar, dëshironi ta instaloni dhe rinisni?",
