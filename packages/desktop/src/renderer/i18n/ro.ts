export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Kito a fost descărcată. Vrei să o instalezi și să repornești?",
