export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của Kito đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
