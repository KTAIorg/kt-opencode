export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Kito er lastet ned. Vil du installere den og starte på nytt?",
