export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Kito telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
