export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Kito versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Kito versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
