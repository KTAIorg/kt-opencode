export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Kito. ¿Quieres instalarla y reiniciar?",
