export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Kito versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
