export const dict = {
  ...
  "desktop.updater.none.message": "כבר מותקנת הגרסה העדכנית ביותר של Kito",
  ...
  "desktop.updater.downloaded.prompt": "גרסה {{version}} של Kito הורדה. להתקין אותה ולהפעיל מחדש את היישום?",
