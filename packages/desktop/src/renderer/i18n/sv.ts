export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Kito har laddats ned. Vill du installera den och starta om programmet?",
