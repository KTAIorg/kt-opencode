export const dict = {
  ...
  "desktop.updater.none.message": "Kito'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Kito'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
