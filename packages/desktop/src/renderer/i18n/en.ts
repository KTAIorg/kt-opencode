export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of ktapi",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of ktapi has been downloaded, would you like to install it and relaunch?",
