export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of KT OpenCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of KT OpenCode has been downloaded, would you like to install it and relaunch?",
