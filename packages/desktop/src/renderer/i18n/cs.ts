export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Kito",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Kito. Chcete ji nainstalovat a aplikaci znovu spustit?",
