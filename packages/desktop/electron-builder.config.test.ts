...
const channels = [
  { channel: "dev", appId: "cc.ktapi.desktop.dev", productName: "Kito Dev", protocolName: "Kito", schemes: ["ktai", "opencode"] },
...
test("keeps a hidden prod launcher for old Linux pins", async () => {
  ...
  expect(desktop).toContain("Exec=/opt/Kito/cc.ktapi.desktop %U")
  expect(desktop).toContain("Icon=cc.ktapi.desktop")
  expect(desktop).toContain("StartupWMClass=cc.ktapi.desktop")
