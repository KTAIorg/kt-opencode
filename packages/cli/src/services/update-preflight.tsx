...
const stages = ["Keeping your session safe", "Starting the new background service", "Loading Kito"] as const
...
function UpdateFooter(props: {
  ...
  const pausedHeader = phrase(["Kito", colors.muted, true], ["update paused", colors.muted])
  const outcomeStatus = () =>
