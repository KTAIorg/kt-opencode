export const dict = {
  ...
  "desktop.menu.ariaLabel": "Kito-meny",
  ...
  "desktop.recovery.loadFailed": "Kito kunde inte läsas in",
  "desktop.recovery.terminated": "Kito-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Kito svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Kito misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "Kito är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "Kito är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "Kito är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kito-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Kito",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Kito.",
  ...
  "dialog.server.description": "Växla vilken Kito-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Kito i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Kito i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Kito i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Kito i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Kito kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Kito kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Kito igen.",
  ...
  "toast.update.description": "En ny version av Kito ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Kito-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Kito stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Kito innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Kito-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Kito",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Kito ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Kito följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Kitos tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Kito startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Kito.",
