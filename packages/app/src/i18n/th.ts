export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Kito",
  "dialog.model.unpaid.addMore.title": "เชื่อมต่อ Kito เพื่อใช้โมเดลแบบชำระเงิน",

  "dialog.provider.viewAll": "เชื่อมต่อ Kito",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kito",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kito",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kito",
  ...
  "titlebar.account.signIn": "เข้าสู่ระบบ",
  "titlebar.account.topUp": "เติมเงิน",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Kito ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Kito...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Kito ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Kito...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Kito ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Kito ใน {{distro}}.",
  "wsl.onboarding.updateOpencode": "อัปเดต Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.opencodeReady": "Kito พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Kito ใน {{distro}}.",
  "wsl.onboarding.installOpencode": "ติดตั้ง Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Kito",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Kito จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Kito ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Kito อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Kito ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Kito",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Kito ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "home.providerTip": "ลงชื่อเข้าใช้ด้วย Telegram เพื่อเติมเงินและใช้โมเดลแบบชำระเงิน",
  ...
  "sidebar.gettingStarted.line1": "Kito รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  "sidebar.gettingStarted.line2": "เมื่อแชทฟรีหมด ให้ลงชื่อเข้าใช้ Kito ด้วย Telegram เพื่อเติมเงินแล้วใช้งานต่อ",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Kito ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Kito",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Kito มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Kito ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Kito มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Kito เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Kito เวอร์ชันล่าสุด",
