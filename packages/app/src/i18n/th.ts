export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Kito ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Kito หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Kito ไม่ตอบสนอง",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kito",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Kito บนอุปกรณ์ของคุณ",
  ...
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Kito",
