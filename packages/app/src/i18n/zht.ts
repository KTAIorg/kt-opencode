...
export const dict = {
  ...
  "desktop.menu.aboutApp": "關於 {{app}}",
  "desktop.menu.hideApp": "隱藏 {{app}}",
  "desktop.menu.hideOthers": "隱藏其他",
  "desktop.menu.unhide": "全部顯示",
  "desktop.menu.quitApp": "結束 {{app}}",
  ...
  "desktop.recovery.loadFailed": "Kito 載入失敗",
  "desktop.recovery.terminated": "Kito 視窗意外終止",
  "desktop.recovery.unresponsive": "Kito 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Kito 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 Kito",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 Kito，但無法執行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Kito",
  "desktop.wsl.error.updateVersion":
    "Kito 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "session.title.new": "新增工作階段",
  "session.title.child": "子工作階段",
  ...
  "dialog.model.manage.description": "自訂模型選擇器中顯示的模型，或切換目前使用的模型。",
  "dialog.model.manage.model.toggle": "在模型選擇器中顯示 {{model}}",
  "dialog.model.manage.showAll": "全部顯示",
  ...
  "dialog.model.group.count.one": "{{count}} 個模型",
  "dialog.model.group.count.other": "{{count}} 個模型",
  "dialog.model.group.available.one": "{{count}}/{{total}} 可用",
  "dialog.model.group.available.other": "{{count}}/{{total}} 可用",
  "dialog.model.group.more.one": "查看全部 {{count}} 個模型",
  "dialog.model.group.more.other": "查看全部 {{count}} 個模型",
  "dialog.model.use": "設為目前",
  "dialog.model.use.current": "使用中",
  "dialog.model.probe.action": "一鍵檢查",
  "dialog.model.probe.running": "檢查中…",
  "dialog.model.probe.progress": "檢查中… {{done}}/{{total}}",
  "dialog.model.probe.done": "模型可用性檢查完成。",
  ...
  "dialog.model.hiddenByUser.one": "已隱藏 {{count}} 個你關閉的模型",
  "dialog.model.hiddenByUser.other": "已隱藏 {{count}} 個你關閉的模型",
  "dialog.model.manage.provider.toggle": "切換所有 {{provider}} 模型",

  "dialog.model.unpaid.freeModels.title": "Kito 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Kito 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Kito 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Kito 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.step.opencode": "Kito",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Kito...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Kito...",
  "wsl.onboarding.updatingOpencode": "正在更新 Kito...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Kito...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Kito。",
  "wsl.onboarding.updateOpencode": "更新 Kito",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Kito 已就緒。",
  "wsl.onboarding.opencodeReady": "Kito 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Kito。",
  "wsl.onboarding.installOpencode": "安裝 Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Kito",
  ...
  "wsl.onboarding.wslUnavailable.description": "Kito 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Kito。",
  ...
  "toast.update.description": "Kito 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Kito 團隊",
  "error.page.report.website": "ktapi.cc",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Kito 尚不支援 MCP 驗證。",
  ...
  "home.providerTip": "用 Telegram 登入後即可使用 Kito 模型。需要時在錢包儲值。",
  ...
  "session.error.model.invalidOutput": "模型回傳了無效回應（例如工具呼叫資料格式錯誤）。請重試，或切換至其他模型。",
  "session.error.model.invalidRequest": "傳送給模型的請求無效。請重試，或切換至其他模型。",
  "session.error.model.empty": "模型未回傳任何內容。請重試，或切換至其他模型。",
  "session.error.model.transport": "無法連線至模型服務。請檢查網路連線後重試。",
  "session.error.model.internal": "模型服務發生暫時性問題。請重試，或切換至其他模型。",
  "session.error.model.rateLimit": "模型服務目前受到速率限制。請稍候再試，或切換至其他模型。",
  "session.error.model.noRoute": "此模型目前無法使用。請切換至其他模型。",
  "session.error.model.contentFilter": "模型拒絕回應此請求。請調整訊息的措辭後重試。",
  "session.error.model.toolResult": "模型服務未回傳工具結果。請重試。",
  ...
  "sidebar.gettingStarted.line1": "Kito 含免費 Zen 對話，打開就能用。",
  "sidebar.gettingStarted.line2": "用 Telegram 登入即可使用 Kito 付費模型。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Kito 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Kito 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Kito 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Kito 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Kito 的主題。",
  ...
  "settings.general.autoAccept.scopeHint": "在工作階段或專案中可用",
  ...
  "settings.updates.row.startup.description": "在 Kito 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Kito。",
  ...
  "toast.project.addFailed.title": "無法新增 {{project}}",
  ...
  "dialog.ktAccess.auth.title": "登入 Kito",
  "dialog.ktAccess.auth.lead": "用 Telegram 登入。登入後可儲值，並繼續使用付費模型。",
  "dialog.ktAccess.auth.signedIn.lead": "你已經登入。模型金鑰無效，請先重新整理金鑰再發送一則訊息。",
  "dialog.ktAccess.refreshKey": "重新整理金鑰",
  "dialog.ktAccess.refreshKey.failed": "無法重新整理 Kito 模型金鑰。請再試一次。",
  "dialog.ktAccess.billing.title": "免費次數已用完",
  "dialog.ktAccess.billing.lead": "Zen 免費對話次數已用盡。登入 Kito 後即可儲值，繼續使用付費模型。",
  "dialog.ktAccess.billing.signedIn.lead":
    "Zen 免費對話次數已用盡。請切換到 Kito 付費模型繼續；餘額不足時先去儲值。",
  "dialog.ktAccess.billing.paid.lead": "Kito 對話額度不足。請先儲值，到帳後再發送一則訊息。",
  "dialog.ktAccess.billing.serviceIssue.lead":
    "你的 Kito 餘額充足，本次失敗是我方閘道或渠道的問題。請稍後重試，或攜帶請求 ID 回報。",
  "dialog.ktAccess.step1": "用 Telegram 登入 Kito（和 NewAPI 同一套帳號）。",
  "dialog.ktAccess.step2": "打開錢包儲值，到帳後即可繼續對話。",
  "dialog.ktAccess.step3": "選一個 Kito 付費模型，再發送一則訊息。",
  "dialog.ktAccess.hint": "用 Telegram 登入。儲值走 Kito 錢包。",
  "dialog.ktAccess.telegram": "用 Telegram 登入",
  "dialog.ktAccess.pasteKey": "貼上 API 金鑰",
  "dialog.ktAccess.saveKey": "儲存 API 金鑰",
  "dialog.ktAccess.openWallet": "去儲值",
  "dialog.ktAccess.dismiss": "不再顯示",
  ...
  "dialog.ktAccess.pickPaidModel": "選擇付費模型",
  "dialog.ktAccess.switch.step1": "打開底部模型選擇器。",
  "dialog.ktAccess.switch.step2": "選擇 Kito 提供商下的付費模型（不要選 Zen Free）。",
  "dialog.ktAccess.switch.step3": "再發送一則訊息——將從 Kito 餘額扣費。",
  "dialog.ktAccess.switch.hint": "無需再貼上金鑰。若餘額不足，再去 Kito 錢包儲值。",
  ...
  "dialog.ktWallet.tabFiat": "微信 / 支付寶",
  "dialog.ktWallet.tabCrypto": "USDT / USDC",
  ...
  "dialog.ktWallet.paying": "正在建立訂單…",
  "dialog.ktWallet.waiting": "請在收銀台完成支付。到帳後視窗會自動更新；如果一直停在成功頁，點「已完成支付」。",
  "dialog.ktWallet.confirmPaid": "已完成支付",
  "dialog.ktWallet.confirmPaid.waiting": "還在確認到帳，請稍候。",
  "dialog.ktWallet.openCashier": "打開收銀台",
  "dialog.ktWallet.back": "返回",
  "dialog.ktWallet.success": "已收到付款。Kito 餘額稍後更新。",
  "dialog.ktWallet.failed": "支付失敗，請重試。",
  "dialog.ktWallet.expired": "訂單已過期，請重新下單。",
  "dialog.ktWallet.loading": "正在取得儲值地址…",
  "dialog.ktWallet.copy": "複製地址",
  "dialog.ktWallet.copied": "已複製地址",
  "dialog.ktWallet.error": "無法取得儲值地址，請稍後再試。",
  "dialog.ktWallet.rateLimited": "取址太頻繁，請過幾分鐘再打開加密貨幣頁。登入是成功的，不必再去 Telegram。",
  "dialog.ktWallet.hint": "不要自己產生地址。鏈上到帳後餘額會更新。",
  "dialog.ktWallet.networkTrc20": "TRC20",
  "dialog.ktWallet.networkErc20": "ERC20",
  "dialog.ktWallet.networkTron": "TRON",
  ...
  "dialog.ktIdentity.codeLabel": "校驗碼",
  "dialog.ktIdentity.codeHint": "確認前請核對校驗碼，避免誤授權。",
  "dialog.ktIdentity.openTelegram": "在本機打開 Telegram（@{{bot}}）",
  "dialog.ktIdentity.openTelegramFallback": "在本機打開 Telegram",
  "dialog.ktIdentity.waiting": "等待 Telegram 確認…",
  "dialog.ktIdentity.creating": "正在建立登入請求…",
  "dialog.ktIdentity.retry": "重新開始",
  "dialog.ktIdentity.noTelegram": "沒有反應？請確認本機已安裝 Telegram，或用手機打開連結。",
  "command.session.background": "移到背景",
  "common.viewAll": "檢視全部",
  "dialog.ktIdentity.copied": "連結已複製",
  "dialog.ktIdentity.copyLink": "複製連結",
  "dialog.ktIdentity.ensureFailed": "已登入，但未能開通 Kito 模型存取權限。請儲值或稍後重試。",
  "dialog.ktIdentity.expired": "此登入請求已過期，請重試。",
  "dialog.ktIdentity.scanQr": "用手機掃碼，在 Telegram 中確認。",
  "dialog.ktWallet.cryptoProgress": "儲值還沒到帳？可在 Kito 主控台檢視儲值記錄。",
  "dialog.ktWallet.cryptoTiming": "鏈上儲值通常幾分鐘內到帳，視網路狀況可能更久。到帳後此視窗會自動關閉。",
  "dialog.ktWallet.loginRequired": "請先透過 Telegram 登入後再儲值。登入成功後本視窗會自動繼續。",
  "project.settings.extensions.added": "已新增到此專案",
  "project.settings.extensions.description": "檢視此專案可用的擴充套件",
  "project.settings.extensions.lsp.description": "根據檔案型別自動偵測",
  "project.settings.extensions.lsp.detected": "偵測到的語言伺服器",
  "project.settings.extensions.setupRequired": "需要設定",
  "project.settings.extensions.shared": "與所有專案共享",
  "project.settings.extensions.tab.lsps": "LSP",
  "project.settings.general.description": "管理專案名稱與外觀",
  "project.settings.scripts": "腳本",
  "project.settings.scripts.description": "設定此專案的腳本",
  "prompt.toast.modelCatalogFailed.description": "請檢查伺服器連線後重試。",
  "prompt.toast.modelCatalogFailed.title": "連線模型服務失敗",
  "prompt.toast.modelCatalogLoading.description": "模型列表仍在載入，稍等片刻即可使用。",
  "prompt.toast.modelCatalogLoading.title": "正在連線到模型服務",
  "session.background.combine": "{{first}} 和 {{second}}",
  "session.background.inBackground": "正在背景執行 {{tasks}}",
  "session.background.moveTasks": "將 {{tasks}} 移到背景",
  "session.background.shell.one": "{{count}} 個 shell",
  "session.background.shell.other": "{{count}} 個 shell",
  "session.background.subagent.one": "{{count}} 個子代理程式",
  "session.background.subagent.other": "{{count}} 個子代理程式",
  "session.new.workspace.fromBranch": "來自 {{branch}}",
  "session.new.workspace.local.tooltip": "使用目前簽出",
  "session.new.workspace.new.tooltip": "建立隔離簽出",
  ...
  "settings.appearance.description": "自訂主題與字型",
  "settings.extensions.addSkills": "如何新增技能",
  "settings.extensions.availableAll": "對所有專案可用",
  "settings.extensions.description": "管理此伺服器上的擴充套件",
  "settings.extensions.manageConfig": "在 opencode.json 中管理",
  "settings.extensions.skills.empty": "暫無技能",
  "settings.extensions.tab.mcps": "MCP",
  "settings.extensions.tab.skills": "技能",
  "settings.general.section.general": "通用",
  "settings.mcps.description": "管理模型上下文協議（MCP）伺服器與工具",
  "settings.notifications.description": "選擇何時接收通知與提示音",
  "settings.preferences.description": "自訂偏好設定、主題與預設行為",
  ...
  "settings.shortcuts.description": "自訂常用操作快捷鍵",
  "settings.tab.extensions": "擴充套件",
  ...
  "settings.workspaces.default.lastUsed": "各專案使用上次的工作區",
  "settings.workspaces.default.local": "本機目錄",
  "settings.workspaces.default.new": "新增工作區",
  "settings.workspaces.default.title": "預設環境",
  "settings.workspaces.delete.blocked.active": "無法刪除正在使用的工作區。",
  "settings.workspaces.delete.blocked.linked": "關聯的工作階段將保留，但其工作目錄將被永久移除。",
  "settings.workspaces.delete.warning": "工作區目錄與分支將被永久刪除，包括下方列出的未合併變更。",
  "settings.workspaces.deleteAll": "刪除所有工作區",
  "settings.workspaces.deleteAll.confirm": "刪除全部 {{count}} 個工作區？",
  "settings.workspaces.deleteAll.warning": "{{project}} 中選中的 {{count}} 個工作區，僅在每個均無未提交變更、未在使用且無關聯工作階段時才會被永久刪除。",
  "settings.workspaces.empty": "暫無工作區",
  "settings.workspaces.filter.all": "所有專案",
  "settings.workspaces.lastActiveSession": "最近活躍工作階段",
  "settings.workspaces.sessions.one": "{{project}} 中的 {{count}} 個工作階段",
  "settings.workspaces.sessions.other": "{{project}} 中的 {{count}} 個工作階段",
  "titlebar.account.signingOut": "正在登出…",
  "workspace.move.failed": "移動工作階段失敗",
  "workspace.move.menu.title": "移動工作階段到",
  "workspace.move.title": "移至工作區",
  "workspace.onboarding.description": "每個工作階段擁有獨立簽出，不會影響你的本機儲存庫",
  "workspace.onboarding.title": "用工作區隔離工作階段",
