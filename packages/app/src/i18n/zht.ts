...
export const dict = {
  ...
  "dialog.ktAccess.hint": "用 Telegram 登入。儲值走 Kito 錢包。已有金鑰可以點下方貼上。",
  ...
  "ui.sessionTurn.error.configureKey": "設定 API 金鑰",
  "ui.sessionTurn.error.switchModel": "切換到 Kito",
  "ui.sessionTurn.error.authFriendly": "API 金鑰無效或已過期。請在 Desktop 設定 Kito 金鑰（設定 → 提供者），或打開引導。",
