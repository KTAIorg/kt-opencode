...
export const dict = {
  ...
  "dialog.model.unpaid.addMore.title": "連接 Kito 使用付費模型",

  "dialog.provider.viewAll": "連接 Kito",
  ...
  "dialog.ktAccess.switch.lead": "Zen 免費對話次數已用盡。本機已設定 Kito API 金鑰——在下方點選一個付費模型即可繼續。",
  ...
  "dialog.ktWallet.lead": "用微信或支付寶付款，或轉入 TRON 上的 USDT。兩種方式記入同一條 Kito 餘額。",
  "dialog.ktWallet.tabFiat": "微信 / 支付寶",
  "dialog.ktWallet.tabCrypto": "USDT",
  "dialog.ktWallet.fiatLoading": "正在載入支付方式…",
  "dialog.ktWallet.fiatHint": "先選金額，再打開收銀台付款。KTPay 確認後餘額會更新。",
  "dialog.ktWallet.fiatDisabled": "目前環境還不能用微信 / 支付寶，請改用 USDT。",
  ...
  "dialog.ktWallet.waiting": "請在收銀台完成支付。到帳後這個視窗會自動更新。",
  ...
  "dialog.ktWallet.error": "無法取得儲值地址。請先用 Telegram 登入後再試。",
  ...
  "ui.sessionTurn.error.configureKey": "登入",
  "ui.sessionTurn.error.switchModel": "切換到 Kito",
  "ui.sessionTurn.error.authFriendly": "登入已失效。請用 Telegram 登入 Kito 後再試。",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Kito 暫不支援 MCP 認證。',
  ...
  "home.providerTip": "用 Telegram 登入後即可儲值，使用付費模型",
  ...
  "sidebar.gettingStarted.line1": "Kito 提供免費模型，你可以立即開始使用。",
  "sidebar.gettingStarted.line2": "免費次數用完後，用 Telegram 登入 Kito 即可儲值繼續。",
