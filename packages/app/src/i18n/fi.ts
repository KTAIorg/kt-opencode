export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kiton tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Kitossa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Kitossa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Kitossa.",
  ...
  "dialog.server.description": "Vaihda Kito-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Kitoa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Kitoa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Kitoa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Kitoa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Kito jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Kito jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kitoa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Kito voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Kito ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Kito uudelleen.",
  ...
  "toast.update.description": "Kiton uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Kito-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Kito ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Kito sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Kito-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Kiton näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Kito näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Kito järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Kiton teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Kito käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Kiton uusinta versiota.",
  ...
  "desktop.menu.documentation": "Kito-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Kito-valikko",
  ...
  "desktop.recovery.loadFailed": "Kiton lataaminen epäonnistui",
  "desktop.recovery.terminated": "Kito-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Kito ei vastaa",
