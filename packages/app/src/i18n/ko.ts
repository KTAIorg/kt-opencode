export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kito를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Kito 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Kito가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "Kito 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.opencodeMissing": "이 배포판에 Kito가 설치되어 있지 않습니다",
  "desktop.wsl.error.opencodeCannotRun": "Kito가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Kito가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "Kito 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
