export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kito에서 제공하는 무료 모델",
  "dialog.model.unpaid.addMore.title": "Kito에 연결해 유료 모델 사용",
  "dialog.provider.viewAll": "Kito 연결",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Kito에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Kito에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Kito에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.ktAccess.auth.title": "Kito에 로그인",
  "dialog.ktAccess.auth.lead": "Telegram으로 로그인하세요. 로그인한 뒤 충전하고 유료 모델을 계속 사용할 수 있습니다.",
  "dialog.ktAccess.billing.title": "무료 채팅을 모두 사용했습니다",
  "dialog.ktAccess.billing.lead": "Zen 무료 채팅을 모두 사용했습니다. Kito에 로그인한 뒤 충전하고 유료 모델로 계속하세요.",
  "dialog.ktAccess.step1": "Telegram으로 Kito에 로그인합니다(NewAPI와 같은 계정).",
  "dialog.ktAccess.step2": "지갑을 열어 충전하면 유료 모델을 계속 사용할 수 있습니다.",
  "dialog.ktAccess.step3": "Kito 유료 모델을 선택한 뒤 다시 보내세요.",
  "dialog.ktAccess.hint": "Telegram으로 로그인하세요. 충전은 Kito 지갑으로 합니다. 키가 있으면 아래에 붙여 넣으세요.",
  "dialog.ktAccess.telegram": "Telegram으로 로그인",
  "dialog.ktAccess.pasteKey": "API 키 붙여넣기",
  "dialog.ktAccess.saveKey": "API 키 저장",
  "dialog.ktAccess.openWallet": "충전하기",
  "dialog.ktAccess.dismiss": "다시 보지 않기",
  "dialog.ktAccess.snooze": "나중에 알림",
  "dialog.ktAccess.switch.title": "무료 한도를 모두 사용했습니다 — Kito로 전환하세요",
  "dialog.ktAccess.switch.lead": "Zen 무료 채팅을 모두 사용했습니다. Kito API 키는 이미 설정되어 있습니다. 아래 유료 모델을 선택해 계속하세요.",
  "dialog.ktAccess.switch.pickHint": "모델을 클릭하면 바로 전환됩니다. 다시 보내면 Kito 잔액에서 청구됩니다.",
  "dialog.ktAccess.switch.empty": "표시된 Kito 모델이 없습니다. 전체 모델 목록을 열어 선택하거나 표시를 관리하세요.",
  "dialog.ktAccess.switch.browseAll": "전체 모델 목록 열기",
  "dialog.ktAccess.switch.step1": "하단 모델 선택기를 엽니다.",
  "dialog.ktAccess.switch.step2": "Kito 제공자의 유료 모델을 선택합니다(Zen Free 제외).",
  "dialog.ktAccess.switch.step3": "다시 보내면 사용량이 Kito 잔액에서 청구됩니다.",
  "dialog.ktAccess.switch.hint": "키를 다시 붙여 넣을 필요는 없습니다. 잔액이 부족하면 Kito 지갑에서 충전하세요.",
  "dialog.ktAccess.switch.ack": "확인",
  "titlebar.account.signIn": "로그인",
  "titlebar.account.topUp": "충전",
  "titlebar.account.signedIn": "{{name}} · {{balance}}",
  "dialog.ktIdentity.title": "Kito 로그인",
  "dialog.ktIdentity.lead": "코드를 스캔하거나 이 기기에서 Telegram을 연 뒤 확인하세요.",
  "dialog.ktIdentity.codeLabel": "확인 코드",
  "dialog.ktIdentity.codeHint": "Telegram에서 확인하기 전에 이 코드가 일치하는지 확인하세요.",
  "dialog.ktIdentity.openTelegram": "Telegram 열기 (@{{bot}})",
  "dialog.ktIdentity.openTelegramFallback": "Telegram 열기",
  "dialog.ktIdentity.waiting": "Telegram 확인을 기다리는 중…",
  "dialog.ktIdentity.creating": "로그인 요청을 만드는 중…",
  "dialog.ktIdentity.retry": "다시 시도",
  "dialog.ktIdentity.noTelegram": "반응이 없나요? Telegram이 설치되어 있는지 확인하거나 휴대폰에서 링크를 여세요.",
  "ui.sessionTurn.error.configureKey": "API 키 설정",
  "ui.sessionTurn.error.switchModel": "Kito로 전환",
  "ui.sessionTurn.error.authFriendly": "API 키가 유효하지 않거나 만료되었습니다. Desktop 설정 → 제공자에서 Kito 키를 설정하거나 가이드를 여세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Kito 서버를 전환합니다.",
  ...
  "toast.update.description": "Kito의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Kito 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Kito는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Kito에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  "sidebar.gettingStarted.line2": "무료 횟수를 모두 쓰면 Telegram으로 Kito에 로그인해 충전한 뒤 계속하세요.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Kito 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Kito 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Kito가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Kito가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Kito 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Kito를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Kito를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Kito 확인 중...",
  "wsl.onboarding.updatingOpencode": "Kito 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Kito 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Kito를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Kito 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Kito를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Kito가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Kito를 설치하세요.",
  "wsl.onboarding.installOpencode": "Kito 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kito에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Kito에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Kito를 다시 여세요.",
  ...
  "home.providerTip": "Telegram으로 로그인하면 충전하고 유료 모델을 사용할 수 있습니다",
