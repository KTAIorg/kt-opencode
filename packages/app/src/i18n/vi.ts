export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Kito",
  ...
  "desktop.recovery.loadFailed": "Không tải được Kito",
  "desktop.recovery.terminated": "Cửa sổ Kito đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Kito không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Kito",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.opencodeMissing": "Kito chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.opencodeCannotRun": "Kito đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.opencodeNotInstalled": "Kito chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Kito nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Kito cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Kito.",
  ...
  "dialog.server.description": "Chuyển máy chủ Kito mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Kito trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Kito trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Kito trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Kito trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Kito có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Kito không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Kito.",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Kito ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Kito",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Kito chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kito bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Kito bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Kito",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Kito trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Kito tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Kito.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Kito khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Kito.",
