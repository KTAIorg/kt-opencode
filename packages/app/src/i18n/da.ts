export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Kito",
  "dialog.model.unpaid.addMore.title": "Forbind Kito for at bruge betalte modeller",

  "dialog.provider.viewAll": "Forbind Kito",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Kito.",
  ...
  "titlebar.account.signIn": "Log ind",
  "titlebar.account.topUp": "Optank",
  ...
  "dialog.server.description": "Skift hvilken Kito-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Kito i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Kito i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Kito i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Kito kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Kito kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Kito igen.",
  ...
  "toast.update.description": "En ny version af Kito ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Kito-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Kito understøtter ikke MCP-godkendelse endnu.',
  ...
  "home.providerTip":
    "Log ind med Telegram for at fylde op og bruge betalte modeller",
  ...
  "sidebar.gettingStarted.line1": "Kito inkluderer gratis modeller så du kan starte med det samme.",
  "sidebar.gettingStarted.line2": "Når de gratis chats er brugt, så log ind på Kito med Telegram for at fylde op.",
  ...
  "settings.desktop.wsl.description": "Kør Kito-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Kito",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Kito ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Kito følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Kito er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Kito starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Kito.",
