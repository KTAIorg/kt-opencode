export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Kito.",
  ...
  "settings.general.row.colorScheme.description":
    "Vælg, om Kito skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Kitos tema.",
  ...
  "desktop.recovery.loadFailed": "Kito kunne ikke indlæses",
  "desktop.recovery.terminated": "Kito-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "Kito svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Kito mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.opencodeMissing": "Kito er ikke installeret i denne distribution",
  "desktop.wsl.error.opencodeCannotRun": "Kito er installeret, men kunne ikke køre",
  "desktop.wsl.error.opencodeNotInstalled": "Kito er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Kito er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
