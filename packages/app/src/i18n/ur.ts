export const dict = {
  ...
  "desktop.menu.documentation": "Kito دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Kito مینو",
  ...
  "desktop.recovery.loadFailed": "Kito لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Kito ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Kito جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Kito کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹری بیوشن میں Kito انسٹال نہیں ہے",
  "desktop.wsl.error.opencodeCannotRun": "Kito انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Kito انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Kito کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Kito کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Kito میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Kito میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Kito میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Kito سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Kito چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Kito چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Kito کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Kito کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Kito کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Kito کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Kito {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Kito تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Kito انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Kito انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Kito WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Kito اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Kito کو دوبارہ کھولیں۔",
  ...
  "toast.update.description": "Kito ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Kito ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Kito ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Kito میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Kito سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Kito کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Kito کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Kito سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Kito کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Kito لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Kito کا تازہ ترین ورژن چلا رہے ہیں۔",
