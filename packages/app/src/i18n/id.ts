export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kito gagal dimuat",
  "desktop.recovery.terminated": "Jendela Kito berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Kito tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Kito gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.opencodeMissing": "Kito belum terinstal di distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Kito telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Kito belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Kito selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Kito",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Kito.",
  ...
  "dialog.server.description": "Ganti server Kito mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Kito di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Kito di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Kito di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Kito di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Kito dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Kito tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Kito.",
  ...
  "toast.update.description": "Versi baru Kito ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Kito",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Kito belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kito menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Kito di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Kito",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Kito di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Kito mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Kito diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Kito.",
