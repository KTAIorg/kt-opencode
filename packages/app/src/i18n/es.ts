export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Kito",
  ...
  "desktop.menu.ariaLabel": "Menú de Kito",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Kito",
  "desktop.recovery.terminated": "La ventana de Kito se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Kito no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Kito",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.opencodeMissing": "Kito no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "Kito está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "Kito no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Kito finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.server.description": "Cambiar el servidor de Kito al que se conecta esta aplicación.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Kito",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Kito aún no admite la autenticación MCP.',
