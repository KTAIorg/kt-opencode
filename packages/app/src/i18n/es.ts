export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Kito",
  "dialog.model.unpaid.addMore.title": "Conecta Kito para usar modelos de pago",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Kito.",
  ...
  "titlebar.account.signIn": "Iniciar sesión",
  "titlebar.account.topUp": "Recargar",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Kito se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Kito en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Kito en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Kito en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Kito en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Kito pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Kito no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Kito.",
  ...
  "toast.update.description": "Una nueva versión de Kito ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Kito",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Kito no soporta autenticación MCP todavía.',
  ...
  "home.providerTip":
    "Inicia sesión con Telegram para recargar y usar modelos de pago",
  ...
  "sidebar.gettingStarted.line1": "Kito incluye modelos gratuitos para que puedas empezar inmediatamente.",
  "sidebar.gettingStarted.line2": "Cuando se acaben los chats gratis, inicia sesión en Kito con Telegram para recargar y continuar.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Kito dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Kito",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Kito en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Kito sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Kito.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Kito",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Kito.",
