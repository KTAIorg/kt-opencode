export const dict = {
  ...
  "desktop.menu.documentation": "Kito Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Kito μενού",
  ...
  "desktop.recovery.loadFailed": "Kito απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Kito το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Kito δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Kito η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.opencodeMissing": "το Kito δεν είναι εγκατεστημένο σε αυτήν τη διανομή",
  "desktop.wsl.error.opencodeCannotRun": "το Kito είναι εγκατεστημένο αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.opencodeNotInstalled": "Kito δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kito η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Kito",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Kito.",
  ...
  "provider.connect.opencodeZen.line1":
    "Kito Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Kito.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Kito συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Kito σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Kito σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Kito σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Kito στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Kito να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Kito δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Kito.",
  ...
  "toast.update.description": "Μια νέα έκδοση του Kito ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Kito",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Kito δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kito περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Kito μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Kito",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Kito στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Kito ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Kito.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Kito",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Kito.",
