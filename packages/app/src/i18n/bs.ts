export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Kito",
  "dialog.model.unpaid.addMore.title": "Poveži Kito za plaćene modele",

  "dialog.provider.viewAll": "Poveži Kito",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Kito-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Kito-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Kito-u.",
  ...
  "titlebar.account.signIn": "Prijavi se",
  "titlebar.account.topUp": "Dopuni",
  ...
  "dialog.server.description": "Promijeni na koji se Kito server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Kito u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Kito u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Kito u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Kito u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Kito mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Kito nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Kito.",
  ...
  "toast.update.description": "Nova verzija Kito-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Kito timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Kito još ne podržava MCP autentifikaciju.',
  ...
  "home.providerTip":
    "Prijavi se putem Telegrama da dopuniš saldo i koristiš plaćene modele",
  ...
  "sidebar.gettingStarted.line1": "Kito uključuje besplatne modele, tako da možeš odmah početi.",
  "sidebar.gettingStarted.line2": "Kad potrošiš besplatne chatove, prijavi se na Kito putem Telegrama da dopuniš saldo.",
  ...
  "settings.desktop.wsl.description": "Pokreni Kito server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Kito-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Kito izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Kito prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Kito-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Kito pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Kito-a.",
