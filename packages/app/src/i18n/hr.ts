...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Kito se nije uspio učitati",
  "Prozor aplikacije Kito neočekivano je zatvoren",
  "Kito ne reagira",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Kito",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Kito.",
  ...
  "dialog.server.description": "Promijenite na koji se Kito poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Kito u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Kito u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Kito u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Kito u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Kito",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Kito može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Kito nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Kito.",
  ...
  "toast.update.description": "Nova verzija Kito ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Kito timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Kito još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Kito uključuje besplatne modele tako da možete odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokrenite Kito poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Kito",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Kito izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Kito slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Kito tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Kito pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Kito.",
