export const dict = {
  ...
  "dialog.ktAccess.hint":
    "Sign in with Telegram. Top-up goes to the Kito wallet. Already have a key? Paste it below.",
  ...
  "ui.sessionTurn.error.authFriendly":
    "API key is invalid or expired. Configure a Kito key in Desktop (Settings → Providers), or open the guide.",
