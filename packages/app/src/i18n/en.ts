...
export const dict = {
  ...
  "dialog.model.manage.description": "Customize which models appear in the model selector, or switch the current model.",
  "dialog.model.manage.model.toggle": "Show {{model}} in the model selector",
  "dialog.model.manage.showAll": "Show all",
  ...
  "dialog.model.group.count.one": "{{count}} model",
  "dialog.model.group.count.other": "{{count}} models",
  "dialog.model.group.available.one": "{{count}} of {{total}} available",
  "dialog.model.group.available.other": "{{count}} of {{total}} available",
  "dialog.model.group.more.one": "View all {{count}} models",
  "dialog.model.group.more.other": "View all {{count}} models",
  ...
  "dialog.model.probe.progress": "Checking… {{done}}/{{total}}",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Kito.",
  ...
  "dialog.server.description": "Switch which Kito server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Kito in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Kito in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Kito in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Kito in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Kito can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Kito could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Kito.",
  ...
  "toast.update.description": "A new version of Kito ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Kito team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Kito does not support MCP authentication yet.',
  ...
  "home.providerTip": "Sign in with Telegram to use Kito models. Top up in the wallet when you need more.",
  ...
  "sidebar.gettingStarted.line1": "Kito includes free Zen chats so you can start immediately.",
  "sidebar.gettingStarted.line2": "Sign in with Telegram to use Kito paid models.",
  ...
  "settings.general.row.language.description": "Change the display language for Kito",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Kito looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Kito follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Kito is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Kito launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Kito.",
  ...
  "dialog.ktAccess.hint": "Sign in with Telegram. Top-up goes to the Kito wallet.",
  ...
  "dialog.ktWallet.lead":
    "Pay with WeChat or Alipay, or send USDT / USDC on TRON or Ethereum. All credit the same Kito balance.",
  "dialog.ktWallet.tabFiat": "WeChat / Alipay",
  "dialog.ktWallet.tabCrypto": "USDT / USDC",
  "dialog.ktWallet.fiatLoading": "Loading payment options…",
  ...
  "dialog.ktWallet.failed": "Payment failed. Try again.",
  "dialog.ktWallet.expired": "Payment expired. Create a new order.",
  ...
  "dialog.ktWallet.networkEthereum": "Ethereum",
  ...
  "dialog.ktWallet.loginRequired": "Sign in with Telegram to top up. The window updates right after sign-in.",
  ...
  "dialog.ktIdentity.codeLabel": "Verification code",
  "dialog.ktIdentity.codeHint":
    "Check this code in Telegram before confirming, so you do not approve the wrong request.",
  "dialog.ktIdentity.openTelegram": "Open Telegram (@{{bot}})",
  "dialog.ktIdentity.openTelegramFallback": "Open Telegram",
  "dialog.ktIdentity.waiting": "Waiting for Telegram confirmation…",
