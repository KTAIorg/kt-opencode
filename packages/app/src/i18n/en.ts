export const dict = {
  ...
  "dialog.ktWallet.lead": "Pay with WeChat or Alipay, or send USDT on TRON. Both credit the same Kito balance.",
  ...
  "dialog.ktWallet.fiatDisabled": "WeChat and Alipay are not available on this environment yet. Use USDT instead.",
