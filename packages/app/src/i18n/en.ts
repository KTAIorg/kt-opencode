export const dict = {
  ...
  "dialog.ktAccess.auth.lead":
    "Sign in with Telegram. Then you can top up and keep chatting.",
  ...
  "dialog.ktWallet.lead": "Pay with WeChat or Alipay, or send USDT / USDC on TRON or Ethereum. All credit the same Kito balance.",
  ...
  "dialog.ktWallet.fiatDisabled": "WeChat and Alipay are not available on this environment yet. Use USDT / USDC instead.",
  ...
  "dialog.ktWallet.hintErc20": "This Ethereum address accepts both USDT and USDC (ERC20). Do not send other chains or coins.",
  ...
  "ui.sessionTurn.error.configureKey": "Sign in",
  "ui.sessionTurn.error.switchModel": "Switch to Kito",
  "ui.sessionTurn.error.authFriendly": "Sign-in expired. Sign in to Kito with Telegram, then try again.",
  ...
  "sidebar.gettingStarted.line1": "Kito includes free models so you can start immediately.",
