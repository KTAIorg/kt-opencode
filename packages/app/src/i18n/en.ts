export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models included with KT OpenCode",
  "dialog.model.unpaid.addMore.title": "Connect KT for paid models",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in KT OpenCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in KT OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in KT OpenCode.",
  ...
  "dialog.ktAccess.auth.title": "Sign in to KT",
  "dialog.ktAccess.auth.lead":
    "Sign in with Telegram using the same KT Identity as NewAPI. Then you can top up and keep chatting.",
  "dialog.ktAccess.billing.title": "Free chats used up",
  "dialog.ktAccess.billing.lead":
    "Zen free chats are exhausted. Sign in to KT, top up, and continue on paid models.",
  "dialog.ktAccess.step1": "Sign in to KT with Telegram (same KT Identity as NewAPI).",
  "dialog.ktAccess.step2": "Open the wallet and top up so paid models keep working.",
  "dialog.ktAccess.step3": "Pick a KT paid model and send again.",
  "dialog.ktAccess.hint":
    "Login is KT Identity. Top-up goes to the KT wallet. Already have a key? Paste it below.",
  "dialog.ktAccess.telegram": "Sign in with Telegram",
  "dialog.ktAccess.pasteKey": "Paste API key",
  "dialog.ktAccess.saveKey": "Save API key",
  "dialog.ktAccess.openWallet": "Top up",
  "dialog.ktAccess.dismiss": "Don’t show again",
  "dialog.ktAccess.snooze": "Remind me later",
  "dialog.ktAccess.switch.title": "Free quota used up — switch to KT",
  "dialog.ktAccess.switch.lead":
    "Zen free chats are exhausted. Your KT API key is already configured — pick a paid KT model below to continue.",
  "dialog.ktAccess.switch.pickHint": "Click a model to switch immediately, then send again (billed to your KT balance).",
  "dialog.ktAccess.switch.empty": "No visible KT models yet. Open the full model list to choose or manage visibility.",
  ...
  "dialog.ktAccess.switch.step2": "Choose a model under the KT provider (not Zen Free).",
  "dialog.ktAccess.switch.step3": "Send again — usage bills to your KT balance.",
  "dialog.ktAccess.switch.hint":
    "You don’t need to paste the key again. If balance is low, top up in the KT wallet.",
  "dialog.ktAccess.switch.ack": "Got it",
  "ui.sessionTurn.error.configureKey": "Configure API key",
  "ui.sessionTurn.error.switchModel": "Switch to KT",
  "ui.sessionTurn.error.authFriendly":
    "API key is invalid or expired. Configure a KT key in Desktop (Settings → Providers), or open the guide.",
  ...
  "dialog.server.description": "Switch which KT OpenCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "KT OpenCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking KT OpenCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking KT OpenCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating KT OpenCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating KT OpenCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update KT OpenCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update KT OpenCode",
  "wsl.onboarding.opencodeReadyIn": "KT OpenCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "KT OpenCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install KT OpenCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install KT OpenCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "KT OpenCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before KT OpenCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "KT OpenCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen KT OpenCode.",
  ...
  "toast.update.description": "A new version of KT OpenCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the KT team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KT OpenCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "KT OpenCode includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "After free chats run out, sign in with Telegram to top up and continue.",
  ...
  "settings.desktop.wsl.description": "Run the KT OpenCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for KT OpenCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how KT OpenCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether KT OpenCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how KT OpenCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when KT OpenCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of KT OpenCode.",
