export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models included with ktapi",
  "dialog.model.unpaid.addMore.title": "Connect ktapi for paid models",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ktapi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ktapi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ktapi.",
  ...
  "dialog.ktAccess.auth.title": "Sign in to ktapi",
  "dialog.ktAccess.auth.lead":
    "Sign in with Telegram using the same KT Identity as NewAPI / ktapi.cc. Then you can top up and keep chatting.",
  "dialog.ktAccess.billing.title": "Free chats used up",
  "dialog.ktAccess.billing.lead":
    "Zen free chats are exhausted. Sign in to ktapi, top up, and continue on paid models.",
  "dialog.ktAccess.step1": "Sign in to ktapi with Telegram (same KT Identity as NewAPI).",
  "dialog.ktAccess.step2": "Open the wallet and top up so paid models keep working.",
  "dialog.ktAccess.step3": "Pick a ktapi paid model and send again.",
  "dialog.ktAccess.hint":
    "Login is KT Identity. Top-up uses settlement app kt-opencode. Already have a key? Paste it below.",
  ...
  "dialog.server.description": "Switch which ktapi server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "ktapi",
  ...
  "wsl.onboarding.checkingOpencode": "Checking ktapi...",
  "wsl.onboarding.checkingOpencodeIn": "Checking ktapi in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating ktapi...",
  "wsl.onboarding.updatingOpencodeIn": "Updating ktapi in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update ktapi in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update ktapi",
  "wsl.onboarding.opencodeReadyIn": "ktapi is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "ktapi is ready.",
  "wsl.onboarding.installOpencodeIn": "Install ktapi in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install ktapi",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ktapi not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before ktapi can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "ktapi could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ktapi.",
  ...
  "toast.update.description": "A new version of ktapi ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ktapi team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ktapi does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "ktapi includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the ktapi server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ktapi",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how ktapi looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ktapi follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ktapi is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ktapi launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ktapi.",
