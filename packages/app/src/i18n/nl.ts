export const dict = {
  ...
  "desktop.menu.documentation": "Kito-documentatie",
  ...
  "desktop.recovery.loadFailed": "Kito kan niet worden geladen",
  "desktop.recovery.terminated": "Het Kito-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Kito reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Kito is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "Kito is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "Kito is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "Kito is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Kito-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Kito",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Kito te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Kito te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Kito te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Kito-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Kito controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Kito bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Kito bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Kito bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kito bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Kito is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Kito in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Kito een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Kito kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Kito opnieuw.",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Kito ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Kito-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Kito ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Kito bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Kito-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Kito",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Kito eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Kito het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Kito aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Kito wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Kito is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Kito.",
