export const dict = {
  ...
  "desktop.menu.documentation": "Kito hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Kito menyusi",
  ...
  "desktop.recovery.loadFailed": "Kito yuklanmadi",
  "desktop.recovery.terminated": "Kito oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Kito javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Kito oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.opencodeMissing": "Kito ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.opencodeCannotRun": "Kito o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.opencodeNotInstalled": "Kito {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Kito yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Kito tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Kito’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Kito da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Kito da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Kito serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Kito {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Kito yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Kito {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Kito-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Kito-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Kito {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Kito tayyor.",
  "wsl.onboarding.installOpencodeIn": "Kito-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Kito-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kito WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Kito WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Kito-ni qayta oching.",
  ...
  "toast.update.description": "Kito ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Kito jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Kito hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Kito bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Kito serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Kito uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Kito qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Kito tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Kito mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Kito ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Kito oxirgi versiyasini ishga tushiryapsiz.",
