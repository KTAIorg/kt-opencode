export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Kito",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Kito.",
  ...
  "dialog.server.description": "Cambia il server Kito a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Kito in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Kito in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Kito in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Kito in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Kito possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Kito non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Kito.",
  ...
  "toast.update.description": "Una nuova versione di Kito ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Kito",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Kito non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kito include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Kito all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Kito",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Kito sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Kito segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Kito.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Kito",
  ...
  "settings.updates.toast.latest.title": "Kito è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Kito.",
  ...
  "desktop.menu.documentation": "Documentazione di Kito",
  ...
  "desktop.menu.ariaLabel": "Menu Kito",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Kito",
  "desktop.recovery.terminated": "La finestra di Kito si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Kito non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Kito non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.opencodeMissing": "Kito non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "Kito è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "Kito non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Kito è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
