export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kito laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Kito aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Kito ei vasta",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Kito",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Kito'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Kito.",
  ...
  "dialog.server.description": "Lülitage, millise Kito serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Kito kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Kito värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Kito värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Kito jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Kito asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Kito saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Kito ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Kito.",
  ...
  "toast.update.description": "Rakenduse Kito ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Kito meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Kito ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Kito sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage Kito server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Kito kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Kito teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Kito järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Kito on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Kito käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Kito uusimat versiooni.",
