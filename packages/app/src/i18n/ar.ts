export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Kito",
  "desktop.recovery.terminated": "توقفت نافذة Kito بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Kito لا يستجيب",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Kito.",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Kito ({{version}}) للتثبيت.",
