export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Kito",
  "dialog.model.unpaid.addMore.title": "اربط Kito لاستخدام النماذج المدفوعة",
  "dialog.provider.viewAll": "ربط Kito",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Kito.",
  ...
  "titlebar.account.signIn": "تسجيل الدخول",
  "titlebar.account.topUp": "شحن",
  ...
  "dialog.server.description": "تبديل خادم Kito الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Kito...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Kito في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Kito...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Kito في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Kito في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Kito في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Kito من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Kito التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Kito.",
  ...
  "toast.update.description": "نسخة جديدة من Kito ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Kito",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Kito لا يدعم مصادقة MCP بعد.',
  ...
  "home.providerTip": "سجّل الدخول عبر Telegram لإعادة الشحن واستخدام النماذج المدفوعة",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Kito نماذج مجانية حتى تتمكن من البدء فورًا.",
  "sidebar.gettingStarted.line2": "بعد نفاد المحادثات المجانية، سجّل الدخول إلى Kito عبر Telegram لإعادة الشحن والمتابعة.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Kito داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Kito",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Kito على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Kito يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Kito.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Kito",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Kito.",
