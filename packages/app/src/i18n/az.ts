export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kito yüklənə bilmədi",
  "desktop.recovery.terminated": "Kito pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Kito cavab vermir",
  ...
  "dialog.model.unpaid.freeModels.title": "Kito tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Kito-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Kito-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Kito-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Kito serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Kito yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Kito yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Kito yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Kito-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Kito-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Kito {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Kito hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Kito-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Kito quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kito WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Kito bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Kito-u yenidən açın.",
  ...
  "toast.update.description": "Kito-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Kito komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Kito hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Kito-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Kito serverini işlət.",
  ...
  "settings.general.row.language.description": "Kito üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Kito-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Kito-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Kito-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Kito açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Kito-un ən son versiyasından istifadə edirsiniz.",
