export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Kito",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Kito",
  "desktop.recovery.terminated": "La fenêtre Kito s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Kito ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Kito",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "Kito n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "Kito est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "Kito n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Kito est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Kito dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Kito dans {{distro}}...",
  ...
  "toast.update.description":
    "Une nouvelle version d'Kito ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Kito ne prend pas encore en charge l'authentification MCP.",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Kito sur votre appareil",
  ...
  "settings.general.row.theme.description": "Personnaliser le thème d'Kito.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Kito",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Kito.",
