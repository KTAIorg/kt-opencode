export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Kito",
  "dialog.model.unpaid.addMore.title": "Connecter Kito pour les modèles payants",
  "dialog.provider.viewAll": "Connecter Kito",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Kito.",
  ...
  "titlebar.account.signIn": "Se connecter",
  "titlebar.account.topUp": "Recharger",
  ...
  "dialog.server.description": "Changez le serveur Kito auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification de Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification de Kito dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour de Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour de Kito dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Kito dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Kito dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Kito puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Kito n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Kito.",
  ...
  "toast.update.description":
    "Une nouvelle version de Kito ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Kito",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Kito ne supporte pas encore l'authentification MCP.",
  ...
  "home.providerTip":
    "Connectez-vous avec Telegram pour recharger et utiliser les modèles payants",
  ...
  "sidebar.gettingStarted.line1":
    "Kito inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  "sidebar.gettingStarted.line2":
    "Quand les discussions gratuites sont épuisées, connectez-vous à Kito avec Telegram pour recharger.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Kito dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Kito",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence de Kito sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Kito suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème de Kito.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement de Kito",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version de Kito.",
