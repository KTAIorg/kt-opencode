export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Kito",
  ...
  "desktop.recovery.loadFailed": "Kito gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Kito ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Kito tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Kito gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.opencodeMissing": "Kito tidak dipasang dalam distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Kito dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Kito tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Kito selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Kito",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Kito.",
  ...
  "dialog.server.description": "Tukar pelayan Kito yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Kito dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Kito dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Kito dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Kito dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Kito boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Kito tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Kito.",
  ...
  "toast.update.description": "Versi baharu Kito ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Kito",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Kito belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kito merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Kito dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Kito",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Kito pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Kito mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Kito.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Kito dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Kito.",
