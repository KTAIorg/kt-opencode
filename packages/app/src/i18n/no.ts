...
export const dict = {
  ...
  "desktop.menu.documentation": "Kito-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "Kito kunne ikke lastes inn",
  "desktop.recovery.terminated": "Kito-vinduet ble uventet avsluttet",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Kito.",
  ...
  "settings.general.row.colorScheme.description":
    "Velg om Kito skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Kito.",
  ...
  "settings.updates.toast.latest.title": "Kito er oppdatert",
