...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Kito",
  "dialog.model.unpaid.addMore.title": "Koble til Kito for å bruke betalte modeller",

  "dialog.provider.viewAll": "Koble til Kito",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Kito.",
  ...
  "titlebar.account.signIn": "Logg inn",
  "titlebar.account.topUp": "Fyll på",
  ...
  "dialog.server.description": "Bytt hvilken Kito-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Kito ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Kito-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Kito ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Kito inkluderer gratis modeller så du kan starte umiddelbart.",
  "sidebar.gettingStarted.line2": "Når de gratis chattene er brukt opp, logg inn på Kito med Telegram for å fylle på.",
  ...
  "settings.desktop.wsl.description": "Kjør Kito-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Kito",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Kito ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Kito skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Kito er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Kito starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Kito.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Kito i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Kito i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Kito i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Kito i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Kito kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Kito kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Kito på nytt.",
  ...
  "home.providerTip":
    "Logg inn med Telegram for å fylle på og bruke betalte modeller",
