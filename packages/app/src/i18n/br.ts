export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Kito",
  "dialog.model.unpaid.addMore.title": "Conecte o Kito para usar modelos pagos",
  "dialog.provider.viewAll": "Conectar Kito",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Kito.",
  ...
  "titlebar.account.signIn": "Entrar",
  "titlebar.account.topUp": "Recarregar",
  ...
  "dialog.server.description": "Trocar para qual servidor Kito este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Kito em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Kito em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Kito em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Kito",
  "wsl.onboarding.opencodeReadyIn": "O Kito está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Kito está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Kito em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Kito possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Kito não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Kito novamente.",
  ...
  "toast.update.description": "Uma nova versão do Kito ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Kito",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Kito ainda não suporta autenticação MCP.',
  ...
  "home.providerTip":
    "Entre com o Telegram para recarregar e usar modelos pagos",
  ...
  "sidebar.gettingStarted.line1": "Kito inclui modelos gratuitos para você começar imediatamente.",
  "sidebar.gettingStarted.line2": "Quando os chats grátis acabarem, entre no Kito com o Telegram para recarregar e continuar.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Kito dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Kito",
  ...
  "settings.general.row.appearance.description": "Personalize como o Kito aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Kito segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Kito é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Kito iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Kito.",
