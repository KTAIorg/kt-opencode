export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Kito",
  ...
  "desktop.menu.ariaLabel": "Menu do Kito",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Kito",
  "desktop.recovery.terminated": "A janela do Kito foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Kito não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Kito",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O Kito não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O Kito está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O Kito não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Kito foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
