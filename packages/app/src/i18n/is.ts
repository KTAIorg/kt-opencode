...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Kito",
  "Kito-glugganum var óvænt lokað",
  "Kito svarar ekki",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Kito",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Kito.",
  ...
  "dialog.server.description": "Skiptu um hvaða Kito miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Kito í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Kito í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Kito í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Kito í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Kito getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Kito gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Kito aftur.",
  ...
  "toast.update.description": "Ný útgáfa af Kito ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Kito teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Kito styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Kito inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "settings.desktop.wsl.description": "Keyrðu Kito netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Kito",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Kito lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Kito fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Kito er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Kito ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Kito.",
