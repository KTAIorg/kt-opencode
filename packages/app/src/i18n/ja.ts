export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kitoが提供する無料モデル",
  "dialog.model.unpaid.addMore.title": "Kito に接続して有料モデルを使う",
  "dialog.provider.viewAll": "Kito に接続",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Kitoで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKitoで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Kitoで{{provider}}モデルを使用してください。",
  ...
  "dialog.ktAccess.auth.title": "Kito にログイン",
  "dialog.ktAccess.auth.lead": "Telegram でログインします。ログイン後にチャージして、有料モデルを使い続けられます。",
  "dialog.ktAccess.billing.title": "無料チャットを使い切りました",
  "dialog.ktAccess.billing.lead": "Zen の無料チャットを使い切りました。Kito にログインしてチャージし、有料モデルで続けてください。",
  "dialog.ktAccess.step1": "Telegram で Kito にログインします（NewAPI と同じアカウント）。",
  "dialog.ktAccess.step2": "ウォレットを開いてチャージすると、有料モデルを使い続けられます。",
  "dialog.ktAccess.step3": "Kito の有料モデルを選んでもう一度送信します。",
  "dialog.ktAccess.hint": "Telegram でログインします。チャージは Kito ウォレットです。キーがある場合は下に貼り付けてください。",
  "dialog.ktAccess.telegram": "Telegram でログイン",
  "dialog.ktAccess.pasteKey": "API キーを貼り付け",
  "dialog.ktAccess.saveKey": "API キーを保存",
  "dialog.ktAccess.openWallet": "チャージする",
  "dialog.ktAccess.dismiss": "今後表示しない",
  "dialog.ktAccess.snooze": "あとで通知",
  "dialog.ktAccess.switch.title": "無料枠を使い切りました — Kito に切り替えてください",
  "dialog.ktAccess.switch.lead": "Zen の無料チャットを使い切りました。Kito API キーは設定済みです。下の有料モデルを選んで続けてください。",
  "dialog.ktAccess.switch.pickHint": "モデルをクリックするとすぐに切り替わります。再送信すると Kito 残高から課金されます。",
  "dialog.ktAccess.switch.empty": "表示中の Kito モデルがありません。モデル一覧を開いて選択または表示を管理してください。",
  "dialog.ktAccess.switch.browseAll": "モデル一覧を開く",
  "dialog.ktAccess.switch.step1": "下部のモデル選択を開きます。",
  "dialog.ktAccess.switch.step2": "Kito プロバイダーの有料モデルを選びます（Zen Free 以外）。",
  "dialog.ktAccess.switch.step3": "もう一度送信します。利用分は Kito 残高から課金されます。",
  "dialog.ktAccess.switch.hint": "キーを再度貼り付ける必要はありません。残高が足りなければ Kito ウォレットでチャージしてください。",
  "dialog.ktAccess.switch.ack": "了解",
  "titlebar.account.signIn": "ログイン",
  "titlebar.account.topUp": "チャージ",
  "titlebar.account.signedIn": "{{name}} · {{balance}}",
  "dialog.ktIdentity.title": "Kito にログイン",
  "dialog.ktIdentity.lead": "QR をスキャンするか、この端末で Telegram を開いて確認してください。",
  "dialog.ktIdentity.codeLabel": "確認コード",
  "dialog.ktIdentity.codeHint": "Telegram で確認する前に、このコードが一致しているか確かめてください。",
  "dialog.ktIdentity.openTelegram": "Telegram を開く（@{{bot}}）",
  "dialog.ktIdentity.openTelegramFallback": "Telegram を開く",
  "dialog.ktIdentity.waiting": "Telegram の確認を待っています…",
  "dialog.ktIdentity.creating": "ログインリクエストを作成しています…",
  "dialog.ktIdentity.retry": "やり直す",
  "dialog.ktIdentity.noTelegram": "反応がない場合は、Telegram がインストールされているか確認するか、スマホでリンクを開いてください。",
  "ui.sessionTurn.error.configureKey": "API キーを設定",
  "ui.sessionTurn.error.switchModel": "Kito に切り替え",
  "ui.sessionTurn.error.authFriendly": "API キーが無効または期限切れです。Desktop の設定 → プロバイダーで Kito キーを設定するか、ガイドを開いてください。",
  ...
  "dialog.server.description": "このアプリが接続するKitoサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Kitoを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のKitoを確認中...",
  "wsl.onboarding.updatingOpencode": "Kitoを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のKitoを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のKitoを更新してください。",
  "wsl.onboarding.updateOpencode": "Kitoを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のKitoの準備ができました。",
  "wsl.onboarding.opencodeReady": "Kitoの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にKitoをインストールしてください。",
  "wsl.onboarding.installOpencode": "Kitoをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kitoがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KitoでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Kitoをもう一度開いてください。",
  ...
  "toast.update.description": "Kitoの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKitoチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KitoはまだMCP認証をサポートしていません。',
  ...
  "home.providerTip": "Telegram でログインするとチャージでき、有料モデルを使えます",
  ...
  "sidebar.gettingStarted.line1": "Kitoには無料モデルが含まれているため、すぐに開始できます。",
  "sidebar.gettingStarted.line2": "無料回数を使い切ったら、Telegram で Kito にログインしてチャージを続けてください。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKitoサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Kitoの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKitoの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Kitoがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Kitoのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Kito の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Kito は最新バージョンです。",
