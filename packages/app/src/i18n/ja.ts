export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kitoを読み込めませんでした",
  "desktop.recovery.terminated": "Kitoのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Kitoが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Kitoのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはKitoがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "Kitoはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはKitoがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Kitoのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
