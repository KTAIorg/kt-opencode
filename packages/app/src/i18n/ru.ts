export const dict = {
  ...
  "desktop.menu.documentation": "Документация Kito",
  ...
  "desktop.menu.ariaLabel": "Меню Kito",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Kito",
  "desktop.recovery.terminated": "Окно Kito неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Kito не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Kito",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.opencodeMissing": "Kito не установлен в этом дистрибутиве",
  "desktop.wsl.error.opencodeCannotRun": "Kito установлен, но его не удалось запустить",
  "desktop.wsl.error.opencodeNotInstalled": "Kito не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Kito завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Kito.",
  ...
  "dialog.server.description": "Выберите сервер Kito, к которому подключается приложение.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Kito требуется WSL (Подсистема Windows для Linux)",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Kito пока не поддерживает MCP-авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Kito на вашем устройстве",
