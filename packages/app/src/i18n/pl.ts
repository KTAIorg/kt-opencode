export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Kito",
  "dialog.model.unpaid.addMore.title": "Połącz Kito, aby używać płatnych modeli",
  "dialog.provider.viewAll": "Połącz Kito",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Kito.",
  ...
  "provider.connect.opencodeZen.line1":
    "Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Kito.",
  ...
  "dialog.ktAccess.billing.lead": "Zen free chats are exhausted. Sign in to Kito, top up, and continue on paid models.",
  ...
  "dialog.ktAccess.switch.lead": "Zen free chats are exhausted. Your Kito API key is already configured — pick a paid Kito model below to continue.",
  ...
  "dialog.ktAccess.switch.hint": "You don’t need to paste the key again. If balance is low, top up in the Kito wallet.",
  "dialog.ktAccess.switch.ack": "Got it",
  "titlebar.account.signIn": "Zaloguj się",
  "titlebar.account.topUp": "Doładuj",
  ...
  "dialog.ktIdentity.codeHint": "Check this code in Telegram before confirming, so you do not approve the wrong request.",
  ...
  "ui.sessionTurn.error.authFriendly": "API key is invalid or expired. Configure a Kito key in Desktop (Settings → Providers), or open the guide.",
  ...
  "dialog.server.description": "Przełącz serwer Kito, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Kito w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Kito w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Kito w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Kito w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Kito będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Kito nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Kito.",
  ...
  "toast.update.description": "Nowa wersja Kito ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Kito",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Kito nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "home.providerTip":
    "Zaloguj się przez Telegram, aby doładować konto i korzystać z płatnych modeli",
  ...
  "sidebar.gettingStarted.line1": "Kito zawiera darmowe modele, więc możesz zacząć od razu.",
  "sidebar.gettingStarted.line2": "Gdy skończą się darmowe czaty, zaloguj się do Kito przez Telegram, aby doładować konto.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Kito wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Kito",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Kito na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Kito ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Kito.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Kito",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Kito.",
