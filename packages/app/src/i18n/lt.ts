...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Kito įkelti nepavyko",
  "Kito langas netikėtai užsidarė",
  "Kito neatsako",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Kito modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Kito.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Kito serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Kito...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Kito {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Kito...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Kito {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Kito {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Kito į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Kito galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Kito nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Kito.",
  ...
  "toast.update.description": "Dabar galima įdiegti naują Kito ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Kito komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Kito dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Kito apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "settings.desktop.wsl.description": "Paleiskite Kito serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Kito ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Kito atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Kito seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Kito temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Kito",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Kito versiją.",
