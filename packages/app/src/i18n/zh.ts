...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kito 加载失败",
  "desktop.recovery.terminated": "Kito 窗口意外终止",
  "desktop.recovery.unresponsive": "Kito 未响应",
  ...
  "dialog.model.manage.description": "自定义模型选择器中显示的模型，或切换当前使用的模型。",
  "dialog.model.manage.model.toggle": "在模型选择器中显示 {{model}}",
  "dialog.model.manage.showAll": "全部显示",
  "dialog.model.manage.visibility.default": "默认",
  "dialog.model.manage.visibility.hide": "全部隐藏",
  ...
  "dialog.model.group.more.one": "查看全部 {{count}} 个模型",
  "dialog.model.group.more.other": "查看全部 {{count}} 个模型",
  "dialog.model.use": "设为当前",
  "dialog.model.use.current": "使用中",
  "dialog.model.probe.action": "一键检测",
  "dialog.model.probe.running": "检测中…",
  "dialog.model.probe.progress": "检测中… {{done}}/{{total}}",
  "dialog.model.probe.done": "模型可用性检测完成。",
  ...
  "dialog.model.hiddenByUser.one": "已隐藏 {{count}} 个你关闭的模型",
  "dialog.model.hiddenByUser.other": "已隐藏 {{count}} 个你关闭的模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Kito 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Kito 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Kito 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Kito...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Kito...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Kito 已就绪。",
  "wsl.onboarding.opencodeReady": "Kito 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Kito。",
  "wsl.onboarding.installOpencode": "安装 Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Kito",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Kito 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Kito 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Kito。",
  ...
  "toast.update.description": "Kito 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Kito 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Kito 暂不支持 MCP 认证。',
  ...
  "home.providerTip": "用 Telegram 登录后即可使用 Kito 模型。需要时在钱包充值。",
  ...
  "session.error.model.invalidOutput": "模型返回了无效响应（例如工具调用数据格式错误）。请重试，或切换到其他模型。",
  "session.error.model.invalidRequest": "发送给模型的请求无效。请重试，或切换到其他模型。",
  "session.error.model.empty": "模型未返回任何内容。请重试，或切换到其他模型。",
  "session.error.model.transport": "无法连接到模型服务。请检查网络连接后重试。",
  "session.error.model.internal": "模型服务出现临时问题。请重试，或切换到其他模型。",
  "session.error.model.rateLimit": "模型服务当前已限流。请稍等片刻后重试，或切换到其他模型。",
  "session.error.model.noRoute": "此模型当前不可用。请切换到其他模型。",
  "session.error.model.contentFilter": "模型拒绝了此请求。请调整消息的措辞后重试。",
  "session.error.model.toolResult": "模型服务未返回工具结果。请重试。",
  ...
  "sidebar.gettingStarted.line1": "Kito 含免费 Zen 对话，打开就能用。",
  "sidebar.gettingStarted.line2": "用 Telegram 登录即可使用 Kito 付费模型。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Kito 服务器。",
  ...
  "settings.general.row.language.description": "更改 Kito 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Kito 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Kito 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Kito 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Kito 启动时自动检查更新",
  ...
  "dialog.ktAccess.auth.title": "登录 Kito",
  "dialog.ktAccess.auth.lead": "用 Telegram 登录。登录后可充值，并继续使用付费模型。",
  "dialog.ktAccess.auth.signedIn.lead": "你已经登录。模型密钥无效，请先刷新密钥再发一条消息。",
  "dialog.ktAccess.refreshKey": "刷新密钥",
  "dialog.ktAccess.refreshKey.failed": "无法刷新 Kito 模型密钥。请再试一次。",
  "dialog.ktAccess.billing.title": "免费次数已用完",
  "dialog.ktAccess.billing.lead": "Zen 免费对话次数已用尽。登录 Kito 后即可充值，继续使用付费模型。",
  ...
  "dialog.ktAccess.hint": "用 Telegram 登录。充值走 Kito 钱包。",
  "dialog.ktAccess.telegram": "用 Telegram 登录",
  "dialog.ktAccess.pasteKey": "粘贴 API 密钥",
  "dialog.ktAccess.saveKey": "保存 API 密钥",
  "dialog.ktAccess.openWallet": "去充值",
  ...
  "dialog.ktAccess.pickPaidModel": "选择付费模型",
  "dialog.ktAccess.switch.step1": "打开底部模型选择器。",
  "dialog.ktAccess.switch.step2": "选择 Kito 提供商下的付费模型（不要选 Zen Free）。",
  ...
  "titlebar.account.signOut": "退出",
  "titlebar.account.console": "Kito 钱包",
  "titlebar.account.signedIn": "{{name}} · {{balance}}",
  "dialog.ktWallet.title": "充值 Kito",
  "dialog.ktWallet.lead": "用微信或支付宝付款，或转入 TRC20 / ERC20 的 USDT、USDC。都记入同一条 Kito 余额。",
  "dialog.ktWallet.tabFiat": "微信 / 支付宝",
  "dialog.ktWallet.tabCrypto": "USDT / USDC",
  "dialog.ktWallet.fiatLoading": "正在加载支付方式…",
  ...
  "dialog.ktWallet.paying": "正在创建订单…",
  "dialog.ktWallet.waiting": "请在收银台完成支付。到账后窗口会自动更新；如果一直停在成功页，点「已完成支付」。",
  "dialog.ktWallet.confirmPaid": "已完成支付",
  "dialog.ktWallet.confirmPaid.waiting": "还在确认到账，请稍候。",
  "dialog.ktWallet.openCashier": "打开收银台",
  "dialog.ktWallet.back": "返回",
  "dialog.ktWallet.success": "已收到付款。Kito 余额稍后更新。",
  "dialog.ktWallet.failed": "支付失败，请重试。",
  "dialog.ktWallet.expired": "订单已过期，请重新下单。",
  "dialog.ktWallet.loading": "正在获取充值地址…",
  "dialog.ktWallet.copy": "复制地址",
  "dialog.ktWallet.copied": "已复制地址",
  "dialog.ktWallet.error": "无法获取充值地址，请稍后重试。",
  "dialog.ktWallet.rateLimited": "取址太频繁，请过几分钟再打开加密货币页。登录是成功的，不必再去 Telegram。",
  "dialog.ktWallet.hint": "不要自己生成地址。链上到账后余额会更新。",
  ...
  "dialog.ktWallet.hintTrc20": "只向这个地址转入 TRON（TRC20）上的 USDT。",
  "dialog.ktWallet.hintErc20": "这个以太坊地址同时收 USDT 和 USDC（ERC20）。不要转入其他链或其他币。",
  "dialog.ktWallet.sharedAddress": "USDT 和 USDC 共用这个以太坊地址，复制一次即可。",
  "dialog.ktWallet.networkMismatch": "这条网络的地址还没准备好。请换一条网络，或稍后再试。",
  "dialog.ktWallet.loginRequired": "请先通过 Telegram 登录后再充值。登录成功后本窗口会自动继续。",
  "dialog.ktIdentity.title": "登录 Kito",
  "dialog.ktIdentity.lead": "扫码或在本机打开 Telegram，确认后自动登录。",
  "dialog.ktIdentity.codeLabel": "校验码",
  "dialog.ktIdentity.codeHint": "确认前请核对校验码，避免误授权。",
  "dialog.ktIdentity.openTelegram": "在本机打开 Telegram（@{{bot}}）",
  "dialog.ktIdentity.openTelegramFallback": "在本机打开 Telegram",
  "dialog.ktIdentity.waiting": "等待 Telegram 确认…",
  "dialog.ktIdentity.creating": "正在创建登录请求…",
  "dialog.ktIdentity.retry": "重新开始",
  ...
  "project.settings.extensions.setupRequired": "需要配置",
  ...
  "settings.notifications.description": "选择何时接收通知与提示音",
  "settings.preferences.description": "自定义偏好设置、主题与默认行为",
  ...
  "settings.shortcuts.description": "自定义常用操作快捷键",
  ...
  "settings.workspaces.default.lastUsed": "各项目使用上次的工作区",
  "settings.workspaces.default.local": "本地目录",
  "settings.workspaces.default.new": "新建工作区",
  "settings.workspaces.default.title": "默认环境",
  "settings.workspaces.delete.blocked.active": "无法删除正在使用的工作区。",
  "settings.workspaces.delete.blocked.linked": "关联的会话将保留，但其工作目录将被永久移除。",
  "settings.workspaces.delete.warning": "工作区目录与分支将被永久删除，包括下方列出的未合并更改。",
  "settings.workspaces.deleteAll": "删除所有工作区",
  "settings.workspaces.deleteAll.confirm": "删除全部 {{count}} 个工作区？",
  "settings.workspaces.deleteAll.warning": "{{project}} 中选中的 {{count}} 个工作区，仅在每个均无未提交更改、未在使用且无关联会话时才会被永久删除。",
  "settings.workspaces.empty": "暂无工作区",
  "settings.workspaces.filter.all": "所有项目",
  "settings.workspaces.lastActiveSession": "最近活跃会话",
  "settings.workspaces.sessions.one": "{{project}} 中的 {{count}} 个会话",
  "settings.workspaces.sessions.other": "{{project}} 中的 {{count}} 个会话",
  "titlebar.account.signingOut": "正在退出登录…",
  ...
  "workspace.move.menu.title": "移动会话到",
  "workspace.move.title": "移至工作区",
  "workspace.onboarding.description": "每个会话拥有独立检出，不会影响你的本地仓库",
  "workspace.onboarding.title": "用工作区隔离会话",
