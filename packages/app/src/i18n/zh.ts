...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 Zen 或 API 密钥连接",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Kito 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Kito 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Kito 中使用 {{provider}} 模型。",
  ...
  "dialog.ktAccess.switch.lead":
    "Zen 免费对话次数已用尽。本机已配置 Kito API 密钥——在下方点选一个付费模型即可继续。",
  ...
  "dialog.ktWallet.waiting": "请在收银台完成支付。到账后这个窗口会自动更新。",
  ...
  "dialog.ktWallet.error": "无法获取充值地址。请先用 Telegram 登录后再试。",
  ...
  "ui.sessionTurn.error.configureKey": "登录",
  "ui.sessionTurn.error.switchModel": "切换到 Kito",
  "ui.sessionTurn.error.authFriendly": "登录已失效。请用 Telegram 登录 Kito 后再试。",
  ...
  "sidebar.gettingStarted.line1": "Kito 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "免费次数用完后，用 Telegram 登录 Kito 即可充值继续。",
