...
export const dict = {
  ...
  "dialog.ktAccess.auth.lead": "当前密钥无效或未配置。在 ktapi.cc 拿到密钥后，点一次即可粘贴到本机。",
  "dialog.ktAccess.billing.title": "充值后，请把密钥粘贴回 Desktop",
  "dialog.ktAccess.billing.lead": "免费额度或余额不足。在 KT AI 充值并创建 API 密钥后，回到这里粘贴。",
  "dialog.ktAccess.step1": "在 ktapi.cc：注册/登录，按需充值，并创建 API 密钥。",
  "dialog.ktAccess.step2": "点「在本机粘贴 API 密钥」——直接进入粘贴框，无需再选登录方式。",
  "dialog.ktAccess.step3": "模型保持 KTAI 付费模型（如 GPT 5.4 Mini），再发送一条消息。",
  "dialog.ktAccess.hint": "Telegram / 密码登录目前不能配置 Desktop 对话——只有粘贴 API 密钥才有效。",
