...
export const dict = {
  ...
  "settings.general.row.newInterface.title": "使用新界面",
  "settings.general.row.newInterface.badge": "新",
  "settings.general.row.newInterface.description": "重新设计的布局、标签页、输入框和主页。旧界面将于{{date}}停用。",
  "settings.general.row.newInterfaceNotice.title": "你现在使用的是新界面",
  "settings.general.row.newInterfaceNotice.description": "旧界面已于{{date}}停用。",
