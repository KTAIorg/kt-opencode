...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ktapi 提供的免费模型",
  "dialog.model.unpaid.addMore.title": "连接 ktapi 使用付费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 ktapi 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 ktapi 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 ktapi 中使用 {{provider}} 模型。",
  ...
  "dialog.ktAccess.auth.title": "登录 ktapi 账号",
  "dialog.ktAccess.auth.lead": "用 Telegram 登录同一套 KT Identity。登录后可充值，并继续使用付费模型。",
  "dialog.ktAccess.billing.title": "免费次数已用完",
  "dialog.ktAccess.billing.lead": "Zen 免费对话次数已用尽。登录 ktapi 后即可充值，继续使用付费模型。",
  "dialog.ktAccess.step1": "用 Telegram 登录 ktapi（和 NewAPI / ktapi.cc 同一套账号）。",
  "dialog.ktAccess.step2": "打开钱包充值，到账后即可继续对话。",
  "dialog.ktAccess.step3": "选一个 ktapi 付费模型，再发送一条消息。",
  "dialog.ktAccess.hint": "登录走 KT Identity；充值走自动到账项目 kt-opencode。已有密钥可以点下方粘贴。",
  ...
  "dialog.server.description": "切换此应用连接的 ktapi 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 ktapi...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 ktapi...",
  "wsl.onboarding.updatingOpencode": "正在更新 ktapi...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 ktapi...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 ktapi。",
  "wsl.onboarding.updateOpencode": "更新 ktapi",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 ktapi 已就绪。",
  "wsl.onboarding.opencodeReady": "ktapi 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 ktapi。",
  "wsl.onboarding.installOpencode": "安装 ktapi",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 ktapi",
  ...
  "wsl.onboarding.wslNotInstalled.description": "ktapi 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "ktapi 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 ktapi。",
  ...
  "toast.update.description": "ktapi 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 ktapi 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: ktapi 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "ktapi 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "免费次数用完后，用 Telegram 登录 ktapi 即可充值继续。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 ktapi 服务器。",
  ...
  "settings.general.row.language.description": "更改 ktapi 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 ktapi 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 ktapi 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 ktapi 的主题。",
  ...
  "settings.updates.row.startup.description": "在 ktapi 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 ktapi。",
