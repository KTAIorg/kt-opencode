...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "KT OpenCode 提供的免费模型",
  "dialog.model.unpaid.addMore.title": "连接 KT 使用付费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 KT OpenCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 KT OpenCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 KT OpenCode 中使用 {{provider}} 模型。",
  ...
  "dialog.ktAccess.auth.title": "登录 KT 账号",
  "dialog.ktAccess.auth.lead": "用 Telegram 登录同一套 KT Identity。登录后可充值，并继续使用付费模型。",
  "dialog.ktAccess.billing.title": "免费次数已用完",
  "dialog.ktAccess.billing.lead": "Zen 免费对话次数已用尽。登录 KT 后即可充值，继续使用付费模型。",
  "dialog.ktAccess.step1": "用 Telegram 登录 KT（和 NewAPI 同一套账号）。",
  "dialog.ktAccess.step2": "打开钱包充值，到账后即可继续对话。",
  "dialog.ktAccess.step3": "选一个 KT 付费模型，再发送一条消息。",
  "dialog.ktAccess.hint": "登录走 KT Identity；充值走 KT 钱包。已有密钥可以点下方粘贴。",
  ...
  "dialog.ktAccess.switch.title": "免费额度已用完 — 请切换到 KT",
  "dialog.ktAccess.switch.lead":
    "Zen 免费对话次数已用尽。本机已配置 KT API 密钥——在下方点选一个付费模型即可继续。",
  "dialog.ktAccess.switch.pickHint": "点选下方模型后会立即切换；然后重新发送消息（从 KT 余额扣费）。",
  "dialog.ktAccess.switch.empty": "当前没有可见的 KT 模型，请打开完整模型列表选择或管理可见模型。",
  "dialog.ktAccess.switch.browseAll": "打开完整模型列表",
  "dialog.ktAccess.switch.step1": "打开底部模型选择器。",
  "dialog.ktAccess.switch.step2": "选择 KT 提供商下的付费模型（不要选 Zen Free）。",
  "dialog.ktAccess.switch.step3": "再发送一条消息——将从 KT 余额扣费。",
  "dialog.ktAccess.switch.hint": "无需再粘贴密钥。若余额不足，再去 KT 钱包充值。",
  "dialog.ktAccess.switch.ack": "知道了",
  "ui.sessionTurn.error.configureKey": "配置 API 密钥",
  "ui.sessionTurn.error.switchModel": "切换到 KT",
  "ui.sessionTurn.error.authFriendly":
    "API 密钥无效或已过期。请在 Desktop 配置 KT 密钥（设置 → 提供商），或打开引导。",
  ...
  "dialog.server.description": "切换此应用连接的 KT OpenCode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 KT OpenCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 KT OpenCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 KT OpenCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 KT OpenCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 KT OpenCode。",
  "wsl.onboarding.updateOpencode": "更新 KT OpenCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 KT OpenCode 已就绪。",
  "wsl.onboarding.opencodeReady": "KT OpenCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 KT OpenCode。",
  "wsl.onboarding.installOpencode": "安装 KT OpenCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 KT OpenCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "KT OpenCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "KT OpenCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 KT OpenCode。",
  ...
  "toast.update.description": "KT OpenCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 KT 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: KT OpenCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "KT OpenCode 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "免费次数用完后，用 Telegram 登录 KT 即可充值继续。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 KT OpenCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 KT OpenCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 KT OpenCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 KT OpenCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 KT OpenCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 KT OpenCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 KT OpenCode。",
