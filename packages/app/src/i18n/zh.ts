...
export const dict = {
  ...
  "dialog.ktAccess.auth.lead": "当前密钥无效或未配置。在 ktapi.cc 拿到密钥后，直接粘贴到下方输入框。",
  "dialog.ktAccess.billing.title": "充值后，请把密钥粘贴回 Desktop",
  "dialog.ktAccess.billing.lead": "免费额度或余额不足。在 KT AI 充值并创建 API 密钥后，粘贴到下方。",
  "dialog.ktAccess.step1": "在 ktapi.cc：注册/登录，按需充值，并创建 API 密钥。",
  "dialog.ktAccess.step2": "把 API 密钥粘贴到下方输入框并保存。",
  "dialog.ktAccess.step3": "模型保持 KTAI 付费模型（如 GPT 5.4 Mini），再发送一条消息。",
  "dialog.ktAccess.hint": "只打开网站不够——必须在这里保存密钥才能继续对话。",
