...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kito tarafından sunulan ücretsiz modeller",
  "dialog.model.unpaid.addMore.title": "Ücretli modeller için Kito’ya bağlanın",

  "dialog.provider.viewAll": "Kito’ya bağlan",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Kito'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Kito'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Kito'da {{provider}} modellerini kullanın.",
  ...
  "titlebar.account.signIn": "Giriş yap",
  "titlebar.account.topUp": "Bakiye yükle",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Kito sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Kito kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Kito güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Kito güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Kito'yu güncelleyin.",
  "wsl.onboarding.updateOpencode": "Kito'yu güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Kito hazır.",
  "wsl.onboarding.opencodeReady": "Kito hazır.",
  "wsl.onboarding.installOpencodeIn": "Kito'yu {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Kito'yu kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito kurulu değil",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Kito'yu tekrar açın.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Kito ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Kito henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "home.providerTip": "Telegram ile giriş yaparak bakiye yükleyin ve ücretli modelleri kullanın",
  ...
  "sidebar.gettingStarted.line1": "Kito ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  "sidebar.gettingStarted.line2": "Ücretsiz sohbetler bitince Telegram ile Kito’ya giriş yapıp bakiye yükleyerek devam edin.",
  ...
  "settings.desktop.wsl.description": "Kito sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.updates.row.startup.description": "Kito başladığında otomatik güncelleme kontrolü yap",
