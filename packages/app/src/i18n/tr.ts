...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Kito yüklenemedi",
  "desktop.recovery.terminated": "Kito penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Kito yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Kito kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.opencodeMissing": "Kito bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "Kito kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.opencodeNotInstalled": "Kito, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Kito güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Kito'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Kito'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Kito hazır.",
  "wsl.onboarding.opencodeReady": "Kito hazır.",
  "wsl.onboarding.installOpencodeIn": "Kito'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Kito'u kur",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kito'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Kito'u tekrar açın.",
  ...
  "toast.update.description": "Kito'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Kito ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Kito henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "settings.general.row.language.description": "Kito'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Kito'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Kito'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Kito'un temasını özelleştirin.",
  ...
  "settings.updates.toast.latest.description": "Kito'un en son sürümünü kullanıyorsunuz.",
