...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Kito zu nutzen.",
  ...
  "home.providerTip":
    "Kito mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.updates.toast.latest.title": "Kito ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Kito wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Kito konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Kito-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Kito reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Kito-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "Kito ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "Kito ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "Kito ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Kito-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
