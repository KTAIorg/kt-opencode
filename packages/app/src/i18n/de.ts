...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Kito",
  "dialog.model.unpaid.addMore.title": "Kito verbinden, um bezahlte Modelle zu nutzen",
  "dialog.provider.viewAll": "Kito verbinden",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Kito zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Kito zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Kito zu nutzen.",
  ...
  "titlebar.account.signIn": "Anmelden",
  "titlebar.account.topUp": "Aufladen",
  ...
  "dialog.server.description": "Wechseln Sie den Kito-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Kito wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Kito in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Kito wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Kito in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Kito in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kito aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Kito ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Kito ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Kito in {{distro}}.",
  "wsl.onboarding.installOpencode": "Kito installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Kito einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Kito konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Kito erneut.",
  ...
  "toast.update.description": "Eine neue Version von Kito ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Kito-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Kito unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Melden Sie sich mit Telegram an, um aufzuladen und bezahlte Modelle zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Kito enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  "sidebar.gettingStarted.line2":
    "Wenn die kostenlosen Chats aufgebraucht sind, mit Telegram bei Kito anmelden und aufladen.",
  ...
  "settings.desktop.wsl.description": "Kito-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Kito ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Kito auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Kito dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Kito anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Kito automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Kito.",
