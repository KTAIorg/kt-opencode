export const dict = {
  ...
  "desktop.menu.documentation": "Kito Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Kito ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Kito se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Kito se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Kito ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.opencodeMissing": "Kito ni nameščen v tej distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "Kito je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "Kito ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Kito je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Kito",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Kito.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Kito.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Kito.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Kito se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Kito ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Kito v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Kito ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Kito v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Kito v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Kito",
  "wsl.onboarding.opencodeReadyIn": "Kito je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Kito je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Kito v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Kito",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Kito ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Kito doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Kito ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Kito.",
  ...
  "toast.update.description": "Nova različica Kito ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Kito",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Kito še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Kito vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Kito znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Kito",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Kito izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Kito sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Kito.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Kito",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Kito.",
