      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>Kito includes free models so you can start immediately.</text>
            <text fg={theme().textMuted}>
              After free chats run out, sign in with Telegram to top up and continue.
            </text>
